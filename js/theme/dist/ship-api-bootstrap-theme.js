...
function pug_escape(e){var a=""+e,t=pug_match_html.exec(a);if(!t)return e;var r,c,n,s="";for(r=t.index,c=0;r<a.length;r++){switch(a.charCodeAt(r)){case 34:n="&quot;";break;case 38:n="&amp;";break;case 60:n="&lt;";break;case 62:n="&gt;";break;default:continue}c!==r&&(s+=a.substring(c,r)),c=r+1,s+=n}return c!==r?s+a.substring(c,r):s}
var pug_match_html=/["&<>]/;function renderShipApiSearchresults(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (offset, ships, size, total) {pug_html = pug_html + "\u003Ctable class=\"table table-hover\"\u003E\u003Cthead\u003E\u003Ctr\u003E\u003Cth\u003ERakennusnumero\u003C\u002Fth\u003E\u003Cth\u003ENimi\u003C\u002Fth\u003E\u003Cth\u003ETyyppi\u003C\u002Fth\u003E\u003Cth\u003ERakennus vuosi\u003C\u002Fth\u003E\u003C\u002Ftr\u003E\u003C\u002Fthead\u003E\u003Ctbody\u003E";
// iterate ships
;(function(){
  var $$obj = ships;
  if ('number' == typeof $$obj.length) {
